...
| F-20 | Catch-up watcher (5-мин poll)                 | ❌     | —                                         | Не начато. Требует: единый Timer 5 мин для F-18/F-19, immediate scan при старте, per-source last_check_ts |

**Легенда:** ✅ полностью реализована | ⚠️ частично | ❌ отсутствует

**Сходимость:** 9/18 фич закрыто (50%) + 7 частично (включая F-17..F-20 как новые ❌).
