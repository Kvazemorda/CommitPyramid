...
**Сходимость:** 16/18 фич закрыто (89%) + 2 частично (F-02 ⚠️ луг через SKTileMapNode внедрён, остатки D-02 в next cycle; F-15 ⚠️ остался TASK-030 — реинициализация карты; F-16 ⚠️ остались TASK-038 тесты UnitPlanner и TASK-040 финальные спрайты Pharaoh).
