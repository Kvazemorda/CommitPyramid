...
**Сходимость:** 19/22 фич закрыто (86%): F-01..F-14 ✅, **F-15 ✅ (TASK-030a/030b/030c — реинициализация карты + biome-aware allocation; followup на replay-aware preferred — отдельная задача)**, F-17..F-20 ✅, F-23 ✅, F-24 ✅, **F-25 ✅ (TASK-047/048a/048b/048c/049/050/051 — egyptian family полностью, Roman/Greek — Backlog)**. F-16 ⚠️ (остался TASK-040 контент-арт, blocked-by F-21). F-21 ❌ open-source. F-22 ❌ не начата.
