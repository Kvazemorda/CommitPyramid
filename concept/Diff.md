...
|-------|------------------------------------------|------------|------------------------------------------------------------------------------|-------|
| D-02  | F-02 Изометрический рендер               | SKTileMapNode 256×256 isometric внедрён через TASK-025 ✅ (программный grass-тайл, debug-overlay CITY_DEBUG_OVERLAY + ⌘⌥F, bench CITY_BENCH_UNITS). **Остаток:** ручная FPS-валидация 60 FPS на 500+ юнитах (manual smoke, нужен macOS GUI). | Подтвердить 60 FPS на 500+ юнитах ручным запуском с CITY_BENCH_UNITS=500 | S  |
...
| D-16  | F-16 Расширенный каталог (50 юнитов)     | UnitKind 51 case + Legacy migration + Placeholder sprites + Terrain affinity + Evolution chains + UnitPlanner biome-aware + Stage-tier visuals + Документация ✅ через TASK-031/032/033/034/035/036/037/039. **Остаток:** Тесты UnitPlanner (TASK-038, разблокирована); финальные Pharaoh-спрайты (TASK-040 escalate-too-large, push в Backlog). | UnitPlanner-тесты + либо real PNG-спрайты Pharaoh-style, либо явное снятие требования | S |
