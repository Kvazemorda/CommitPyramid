...
| D-06  | F-06 Project-District и размещение       | Приоритет руин не реализован (зависит от F-09)                              | Новый проект при наличии руин → выбирает руины с анимацией расчистки         | S     |
| D-07  | F-07 Состав и баланс юнитов              | Паттерн на 20 шагов, пропорции не валидированы; нет правил «N жилых → колодец» | 20+ юнитов в квартале содержат все 4 категории в пропорции ±10%             | S     |
